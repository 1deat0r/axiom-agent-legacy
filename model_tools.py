...
# ADR-0092: tool-argument coercion lives in its own root-level module.
...
def _compute_tool_definitions(
    ...
    # ADR-0091: the dynamic-schema seam owns every per-session schema rewrite
    # (execute_code sandbox list, discord intents, browser_navigate web
    # cross-ref, browser_exec terminal gate) — registered beside each tool via
    # dynamic_schema_overrides. This assembler knows no tool names.
