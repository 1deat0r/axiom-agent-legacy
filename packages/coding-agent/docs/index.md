...
```bash
# Axiom is installed by the self-deploy script (see ~/.axiom/axiom-self-deploy.sh)
# or your preferred packaging path.
```
...
- [Using Axiom](usage.md) - interactive mode, RLM subagents, slash commands, context files, and CLI reference.
...
- [Skills](skills.md) - markdown and Python-backed skills, including how to ask Axiom to create them.
...
- [Axiom packages](packages.md) - bundle and share extensions, skills, prompts, and themes.
- [Custom models](models.md) - add model entries for supported provider APIs.
- [Custom providers](custom-provider.md) - implement custom APIs and OAuth flows.

## Programmatic Usage

- [SDK](sdk.md) - embed Axiom in Node.js applications.
- [ACP mode](acp.md) - drive Axiom from any Agent Client Protocol client.
