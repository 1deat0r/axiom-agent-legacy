...
### Base Message Types (from Axiom AI)
...
### Extended Message Types (from Axiom Coding Agent)
...
- `fromHook`: `true` if generated by an extension, `false`/`undefined` if generated by Axiom (legacy field name)
