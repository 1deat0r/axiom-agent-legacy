> Axiom can create prompt templates. Ask it to build one for your workflow.
...
Axiom loads prompt templates from:

- Global: `~/.axiom/agent/prompts/*.md`
- Project: `.axiom/agent/prompts/*.md`
