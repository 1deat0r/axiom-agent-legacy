...
Example extensions for Axiom.

## Usage

```bash
# From the repository root, load an extension with --extension
./axiom.sh --extension packages/coding-agent/examples/extensions/permission-gate.ts

# Or copy to extensions directory for auto-discovery
cp permission-gate.ts ~/.axiom/agent/extensions/
```
...
| Extension | Description |
|-----------|-------------|
| `mac-system-theme.ts` | Syncs the Axiom theme with macOS dark/light mode |
