...
describe("buildSystemPrompt", () => {
	test("injects compact global harness context and refine guidance by default", () => {
		...
		expect(prompt).toContain("Local continual harness entries belong to this Axiom session");
		...
		expect(prompt).toContain("[global:validation] Validation (repo/axiom, v2): Run `npm run check`");
