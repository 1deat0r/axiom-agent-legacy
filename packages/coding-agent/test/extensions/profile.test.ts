...
import { defaultLedgerDeps } from "../../src/extensions/ledger/index.ts";
import { createMemoryExtension } from "../../src/extensions/memory/index.ts";
import axiomProfileExtension, { createProfileExtension, soulBlock } from "../../src/extensions/profile/index.ts";
import {
	AXIOM_HOME_ENV,
	axiomHome,
	isValidProfileName,
