"""Axiom session-to-session messaging skill.

All routing and sender identity live in the TypeScript daemon. These functions
only call the host bridge exposed inside the Axiom IPython kernel.
"""
...
_MESSAGE_DISPLAY_MIME = "application/vnd.axiom.agent-message+json"
