...
export async function createAgentSessionServices(
	...
	if (
		...
		diagnostics.push({
			type: "info",
			message:
				"Axiom sends pseudonymous usage and performance metrics without prompts, responses, tool content, file paths, or repository data. Disable this with telemetry.enabled=false, AXIOM_TELEMETRY=0, DO_NOT_TRACK=1, or offline mode.",
		});
