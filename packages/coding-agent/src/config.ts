...
export const SELF_UPDATE_INTERACTIVE_CHILD_ENV = "AXIOM_INTERACTIVE_SELF_UPDATE";
...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/PrimeIntellect-ai/axiom/releases/latest`;
	}
	if (method === "homebrew") {
...
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".axiom/agent";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., PI_CODING_AGENT_DIR or AXIOM_CODING_AGENT_DIR
...
// =============================================================================
// User Config Paths (~/.axiom/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.axiom/agent/) */
...
/** Directory where daemon and client diagnostic logs are written (e.g. ~/.axiom/agent/logs/). */
