...
- Removed the fullscreen image fallback instruction and kept fullscreen overlays from emitting terminal graphics ([#437](https://github.com/PrimeIntellect-ai/axiom/pull/437) by [@snimu](https://github.com/snimu)).
...
- Fixed fullscreen dock selection so prompt text can be copied ([#342](https://github.com/PrimeIntellect-ai/axiom/pull/342)).

## [0.2.8] - 2026-07-09

## [0.2.7] - 2026-07-08

- Fixed full TUI redraws to preserve terminal scrollback on resize and shrink redraws ([#331](https://github.com/PrimeIntellect-ai/axiom/pull/331) by [@sethkarten](https://github.com/sethkarten)).
...
- Added fullscreen viewport rendering with alternate-screen scrolling, follow controls, mouse selection, and clipboard copy hooks ([#316](https://github.com/PrimeIntellect-ai/axiom/pull/316)).
...
- Added `fuzzyFilterScored`, returning scored matches so callers can break ties by recency; `fuzzyFilter` delegates to it unchanged ([#251](https://github.com/PrimeIntellect-ai/axiom/issues/251)).
- Changed the editor to expose `rlmChildLabel` (whitespace-normalized full prompt) and centralized the "still working" pulse glyph in `working-icon.ts` for shared use across panels and lists ([#247](https://github.com/PrimeIntellect-ai/axiom/issues/247)).
...
- Added marquee TUI components and a Prime-branded theme as part of the initial Axiom fork from pi-mono.
