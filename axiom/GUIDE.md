# Axiom — operating guide (Hermes baseline)
...
Hermes's own `AGENTS.md` (repo root) is the authoritative development guide
for the Python core — read it before touching Python. This file is Axiom's
layer on top.
...
Axiom's TS sovereign layer (once scaffolded): `node --test`, `tsc --noEmit`.
